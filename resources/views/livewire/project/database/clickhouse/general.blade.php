<div>
    <form wire:submit="submit" class="flex flex-col gap-2">
        ...
        <div>
            ...
            <x-forms.input placeholder="9000" :disabled="true" id="publicPort" label="Public Port" helper="Auto-assigned from the configured port range." canGate="update" :canResource="$database" />
        </div>
    </form>
