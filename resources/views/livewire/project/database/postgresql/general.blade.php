        ...
        <div class="flex flex-col gap-2">
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <x-forms.input placeholder="5432" :disabled="true" id="publicPort"
                        label="Public Port" helper="Auto-assigned from the configured port range." canGate="update" :canResource="$database" />
                </div>
